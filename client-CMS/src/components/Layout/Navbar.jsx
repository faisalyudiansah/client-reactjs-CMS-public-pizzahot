                ...
                <div className="navbar bg-base-300">
                    ...
                    <div className="navbar-center  hidden lg:flex pb-1">
                        <ul className="menu font-medium menu-horizontal rounded-xl items-center  text-base gap-5">
                            <li><a className='rounded-lg' href="/">Cuisines</a></li>
                            <li><a className='rounded-lg' href="/list-category">Categories</a></li>
                            <li><a className='rounded-lg' href="/add-user">Add User</a></li>
                        </ul>
                    </div>

                    <div className="navbar-end px-3 pb-1">
                        <a className="btn rounded-xl" onClick={logoutHandler}>Logout</a>
